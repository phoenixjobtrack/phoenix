        ...
        <List>
          ...
          <ListItem>
            <Select
              ...
              value={
                this.props.reduxState.currentStage[this.props.i].stage || ''
              }
              inputProps={{
                name: 'stage',
                id: 'stage-simple',
        ...
        <List>
          ...
          <ListItem style={{ width: 175 }}>
            <TextField
              ...
              type='date'
              value={moment(
                this.props.reduxState.currentStage[this.props.i].date ||
                  new Date(),
              ).format('YYYY-MM-DD')}
              InputLabelProps={{
                shrink: true,
        ...
        <List style={{ width: 300 }}>
          ...
          <ListItem>
            <TextField
              ...
              value={
                this.props.reduxState.currentStage[this.props.i].note || ''
              }
              inputProps={{
