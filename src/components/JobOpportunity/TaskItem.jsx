        ...
        <List>
          ...
          <ListItem>
            <TextField
              style={{ minWidth: 230 }}
              value={
                this.props.reduxState.currentTasks[this.props.i].taskName || ''
              }
        ...
        <List>
          ...
          <ListItem style={{ width: 175 }}>
            <TextField
              ...
              type='date'
              value={moment(
                this.props.reduxState.currentTasks[this.props.i].dueDate ||
                  new Date(),
              ).format('YYYY-MM-DD')}
        ...
        <List style={{ width: 300 }}>
          ...
          <ListItem>
            <TextField
              style={{ width: '100%' }}
              value={
                this.props.reduxState.currentTasks[this.props.i].note || ''
              }
