...
class EditJobOpp extends Component {
  ...
  handleJobChange = (propertyName) => (event) => {
    this.props.dispatch({
      ...
      payload: { key: propertyName, value: event.target.value },
    })
  }
  ...
  render() {
    // console.log('EditJobOpp props: ', this.props)
    return (
      <div>
        <h2>
          <Box>Job Opportunity</Box>
        </h2>
                  ...
                  <List>
                    ...
                    <ListItem>
                      ...
                      <TextField
                        ...
                        type='date'
                        value={moment(
                          this.props.currentJob.deadline || new Date(),
                        ).format('YYYY-MM-DD')}
