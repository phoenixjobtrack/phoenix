      ...
      >
        ...
        <List>
          ...
          <ListItem component={Link} to='/tasks' button>
            <ListAltIcon className='icon' /> Tasks
          </ListItem>
          <ListItem component={Link} to='/jobpipeline' button>
            <ViewAgendaIcon className='icon' /> Job Pipeline
          </ListItem>
          ...
          <ListItem component={Link} to='/contact' button>
            <ContactsIcon className='icon' /> Contacts
          </ListItem>
          <ListItem component={Link} to='/profile' button>
            <AccountIcon className='icon' /> Profile
          </ListItem>
        </List>
        <Divider />
        <List>
          <ListItem onClick={() => props.dispatch({ type: 'LOGOUT' })} button>
