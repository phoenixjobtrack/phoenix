...
INSERT INTO "jobs"
    ("user_id", "position", "company_name", "notes", "posting_url", "deadline", "compensation", "benefits", "travel", "closed")
VALUES
...
INSERT INTO "contacts"
    ("user_id", "first_name", "last_name", "company", "position", "email", "linkedin_url",
...
INSERT INTO "tasks"
    ("user_id", "task_name", "due_date", "complete", "contact_id", "job_id", "disabled")
VALUES
...
VALUES
    ...
    ('Hiring MGR - Phone Screen'),
    ('Director Interview'),
    ('Director - Phone Screen'),
    ('VP Interview'),
    ('VP - Phone Screen'),
    ('Await Decision'),
    ('Peer Interview'),
